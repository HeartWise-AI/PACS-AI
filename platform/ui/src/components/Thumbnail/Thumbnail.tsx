  ...
  return (
    <div
      className={classnames(
        className,
        'group flex flex-1 cursor-pointer select-none flex-col outline-none'
      )}
    ...
    >
      <div ref={drag}>
        <div
          className={classnames(
            'flex h-32 flex-1 items-center justify-center overflow-hidden rounded-md bg-transparent text-base text-white',
            isActive
