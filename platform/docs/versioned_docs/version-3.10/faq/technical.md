...
The study panel supports sorting display sets by specific values. It includes default sorting functions such as Series Number, Series Image Count, and Series Date.
...
You can customize sorting in the study panel by using `studyBrowser.sortFunctions`. This will look like:
