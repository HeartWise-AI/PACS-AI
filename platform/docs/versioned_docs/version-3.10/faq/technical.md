...
`StudyBrowserSort` appears in the study panel settings and allows sorting series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
You can use the built-in study panel sort controls to change thumbnail and study browser sorting. This will look like:
