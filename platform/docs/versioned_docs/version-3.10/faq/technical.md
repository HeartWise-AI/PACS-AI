...
The StudyBrowserSort dropdown is available in the study panel settings row. It lets you sort the series by a specific value and includes 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
You can use the study browser sorting dropdown shown below:
