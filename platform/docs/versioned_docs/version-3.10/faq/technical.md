...
The StudyBrowserSort component is available in the study panel and lets you sort series by specific values. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study panel includes a sort component to change display set order. This will look like:
