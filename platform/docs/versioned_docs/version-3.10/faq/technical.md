...
The StudyBrowserSort component is available in the study panel and lets you sort series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The built-in study panel sorting UI looks like this:
