...
The StudyBrowser sort dropdown is available in the study panel and lets you sort series by specific values. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
You can use the built-in StudyBrowser sorting UI. This will look like:
