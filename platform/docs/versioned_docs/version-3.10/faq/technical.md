...
The StudyBrowserSort component is available in the study panel and provides a dropdown to sort series by a specific value. It comes with 3 default sorting functions, Series Number, Series Image Count, and Series Date.
...
The study panel supports the StudyBrowserSort component by default. This will look like:
