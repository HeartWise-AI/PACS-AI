...
The StudyBrowserSort component appears in the study panel settings and allows you to sort the series by a specific value. It comes with 3 default sorting functions, Series Number, Series Image Count, and Series Date.
...
You can use the study panel settings to sort thumbnails with the StudyBrowserSort component. This will look like:
