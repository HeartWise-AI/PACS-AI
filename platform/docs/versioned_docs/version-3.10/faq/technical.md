...
The StudyBrowserSort component is available in the study panel and lets you sort the series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
You can use the built-in sorting dropdown in the study panel. It will look like:
