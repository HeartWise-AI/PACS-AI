...
Open the study panel settings to use the StudyBrowserSort dropdown. It allows you to sort the series by a specific value and comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study panel settings expose the StudyBrowserSort component:
