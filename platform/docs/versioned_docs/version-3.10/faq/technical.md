...
The Study Browser sort dropdown is available in the study panel and allows sorting by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study panel includes a sort dropdown for changing thumbnail and study browser ordering. This will look like:
