...
The StudyBrowserSort component is available in the study panel and adds a dropdown to sort series by a specific value.
...
The study panel includes sorting controls out of the box. This looks like:
