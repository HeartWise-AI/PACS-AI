...
The Study Browser includes a sort dropdown in the study panel by default. It provides built-in sorting functions such as Series Number, Series Image Count, and Series Date.
