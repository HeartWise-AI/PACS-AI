...
Use the Study Browser sorting customizations. The StudyBrowserSort component appears in the study panel when settings are available and includes default sort options such as Series Number, Series Image Count, and Series Date.
...
The study panel includes sorting controls. This will look like:
