...
The Study Browser sort dropdown is available in the study panel and can be customized to sort series by different values. It comes with three default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study browser includes a sort dropdown for changing thumbnail/study panel ordering:
