...
The study panel includes a sort dropdown that lets you sort the series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study browser includes a sort control in the study panel. This will look like:
