...
The study panel includes a dropdown for sorting series by a specific value. It comes with 3 default sorting functions, Series Number, Series Image Count, and Series Date.
...
The study browser sort control is available in the study panel:
