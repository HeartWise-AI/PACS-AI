...
The StudyBrowserSort component is available in the study panel when panel settings are shown. It includes default sorting functions (Series Number, Series Image Count, and Series Date).
...
The study browser supports configurable sorting through `studyBrowser.sortFunctions`. This will look like:
