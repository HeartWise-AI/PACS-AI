...
The Study Browser sort control appears in the study panel when study browser settings are enabled. It allows you to sort the series by a specific value and comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The Study Browser sort control looks like this:
