...
The Study Browser includes sorting controls in the panel. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The Study Browser provides built-in sorting controls:
