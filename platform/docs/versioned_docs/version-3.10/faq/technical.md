...
The StudyBrowserSort component provides a dropdown in the study panel for sorting series by specific values. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The StudyBrowserSort component appears in the study panel and allows you to choose the sorting function for thumbnails and series:
