...
The `StudyBrowserSort` component appears in the study panel when study browser settings controls are shown. It allows you to sort the series by a specific value and comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study browser sort control looks like:
