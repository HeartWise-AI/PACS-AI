...
The StudyBrowserSort component is available in the study panel settings area and lets you sort the series by a specific value. It comes with 3 default sorting functions, Series Number, Series Image Count, and Series Date.
...
You can use the StudyBrowserSort dropdown in the study panel settings area to change sorting. This will look like:
