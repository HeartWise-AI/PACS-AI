...
The study panel includes sorting controls by default and comes with 3 built-in sort functions: Series Number, Series Image Count, and Series Date.
...
You can customize sorting behavior in the study browser by adding `studyBrowser.sortFunctions` customizations. This will look like:
