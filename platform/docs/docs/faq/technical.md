...
The study panel includes a sorting dropdown that lets you sort series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
We are currently redesigning the study panel and the study browser. The sorting dropdown in the study panel looks like:
