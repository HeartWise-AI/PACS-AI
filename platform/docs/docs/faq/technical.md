...
The Study Browser includes a sort control in the study panel to sort series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study panel includes a sort control in the Study Browser:
