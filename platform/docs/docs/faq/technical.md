...
The StudyBrowser sort dropdown is available in the study panel and allows sorting by specific values. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study panel includes a sort dropdown by default. This will look like:
