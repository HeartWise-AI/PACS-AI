...
The study panel includes `StudyBrowserSort`, which provides a dropdown to sort series by a specific value.
It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The sorting UI is available in the study browser:
