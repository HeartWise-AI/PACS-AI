...
The study panel includes the StudyBrowserSort component, which provides a dropdown to sort the series by a specific value. It comes with 3 default sorting functions, Series Number, Series Image Count, and Series Date.
...
You can change sorting behavior using the StudyBrowserSort UI and customization entries. This will look like:
