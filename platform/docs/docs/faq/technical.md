...
The StudyBrowserSort component in the study panel allows sorting series by specific values. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
You can change sorting behavior by using custom sort functions in `studyBrowser.sortFunctions`. This will look like:
