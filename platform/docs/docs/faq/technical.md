...
The StudyBrowserSort component is available in the study panel and allows you to sort series by a specific value. It comes with 3 default sorting functions, Series Number, Series Image Count, and Series Date.
...
The StudyBrowserSort component is available in the study panel and looks like:
