...
The StudyBrowserSort component appears in the study panel settings and allows you to sort the series by a specific value. It comes with default sorting functions such as Series Number and Series Date.
...
The study panel settings include a sorting component that looks like:
