...
The study panel includes a sorting dropdown that lets you sort the series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
You can change sorting in the study panel and study browser using the built-in sorting dropdown. It will look like:
