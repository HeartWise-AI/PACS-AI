...
The StudyBrowserSort component adds a dropdown in the study panel to sort the series by a specific value. This component is experimental
...
We are currently redesigning the study panel and the study browser. The sorting component appears in the study panel like this:
