...
The StudyBrowserSort component appears in the study panel when study browser settings are enabled. It includes default sorting functions such as Series Number, Series Image Count, and Series Date.
...
We are currently redesigning the study panel and the study browser. The sorting UI appears in the study panel when study browser settings are enabled. This will look like:
