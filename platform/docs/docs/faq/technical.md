...
The StudyBrowserSort component is available in the study panel. You can sort the series by defining sorting functions in customization.
...
You can change sorting by configuring `studyBrowser.sortFunctions` through the customization service. This will look like:
