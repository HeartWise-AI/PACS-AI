...
The study panel includes a sort dropdown in the settings row that can sort the series by a specific value. It comes with default sort functions such as Series Number, Series Image Count, and Series Date.
...
You can use the study browser sorting controls and provide your own sort functions through customization. This will look like:
