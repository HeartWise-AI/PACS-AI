...
The study panel includes a sort dropdown that allows sorting series by specific values. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study panel includes a built-in sorting component. This will look like:
