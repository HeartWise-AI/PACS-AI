...
The StudyBrowserSort component is available in the study panel and allows you to sort the series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study panel includes the sorting component by default. This will look like:
