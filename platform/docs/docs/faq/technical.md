...
The Study Browser sort control is available in the study panel and allows sorting series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study panel and study browser include a sort control that looks like:
