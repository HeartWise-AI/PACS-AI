...
The study panel includes a dropdown to sort the series by a specific value. It comes with 3 default sorting functions, Series Number, Series Image Count, and Series Date.
...
The study browser includes sorting controls in the study panel:
