...
The StudyBrowserSort component is available in the study panel and provides a dropdown for sorting series by a specific value. It comes with 3 default sorting functions: Series Number, Series Image Count, and Series Date.
...
The study panel includes the StudyBrowserSort component for sorting display sets. It will look like:
