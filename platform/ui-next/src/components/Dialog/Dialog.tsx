...
>(({ className, children, unstyled, ...props }, ref) => {
  ...
  const contentClassName = cn(
    ...
    'max-w-md bg-[#4C504B] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] fixed left-[50%] top-[50%] z-50 grid gap-4 p-4 shadow-lg duration-200 sm:rounded-lg',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    // NOTE: This is a PACS changes
    className={cn('text-foreground text-xl font-normal leading-none tracking-tight', className)}
    {...props}
  />
));
