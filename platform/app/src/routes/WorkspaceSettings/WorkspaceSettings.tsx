...
const WorkspaceSettingsPage = () => {
  ...
  const handleSaveIngestionJob = async () => {
    ...
    const selectedModel = inference.availableModels.find(m => m.containerId === newJobModel.value);
                ...
                <li>
                  <button
                    ...
                    onClick={() => {
                      ...
                      const matchedModel = inference.availableModels.find(
            ...
            <div className="relative">
              ...
              <div className="mt-4 flex flex-col gap-4">
                ...
                <select
                  ...
                  onChange={e => {
                    const selected = inference.availableModels.find(
                ...
                >
                  ...
                  {inference.availableModels.map(m => (
                    <option
                      key={m.containerId}
                      value={m.containerId}
                    >
                ...
                <div>
                  ...
                  >
                    ...
                    {(
                      inference.availableModels.find(m => m.containerId === newJobModel?.value)
