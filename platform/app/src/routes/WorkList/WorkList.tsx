...
function WorkList({
  ...
  return (
    <div className="flex h-screen flex-col bg-[#151815]">
      {/* <Header
        isSticky
      ...
      <div className="flex">
        ...
        <div className="relative m-5 h-screen w-72 bg-white bg-opacity-10 p-4">
          <h5
          ...
          {/* <button
            ...
            className="end-2.5 absolute top-2.5 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-transparent text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white"
          >
            <svg
              className="h-3 w-3"
              aria-hidden="true"
            ...
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                  ...
                  <span className="ms-3">Studies</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="ms-3">AI Models</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="ms-3">AI Predictions</span>
                </a>
              </li>
            </ul>
          </div>
