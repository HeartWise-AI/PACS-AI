...
export const AlertProvider = ({ children }) => {
  ...
  return (
    <AlertContext.Provider value={showAlert}>
      {children}
      {alert.message && <div className={`${alert.variant} fixed left-1/2 top-0 z-[99999] w-full -translate-x-1/2 rounded-none text-white p-3 text-center`}>{alert.message}</div>}
